...
from VeraGridEngine import DynamicVarType, power_flow
...
# load
load0 = Load(P= 7.5, Q= 1.0)
grid.add_load(bus=bus2, api_obj=load0)

# Generators
gen0 = Generator(name="Gen0", P=4.0, vset=1.0, Snom = 900)
# gen1 = Generator(name="Gen2", P=3.5, vset=1.0, Snom = 900)
...
# ----------------------------------------------------------------------------------------------------------------------
sys = Block(
    children=[line0_block, load, generator0_block, bus0_block, bus2_block],
    in_vars=[]
)
