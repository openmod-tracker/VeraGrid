...
"}")
        ...
        self.tabWidget_7 = QTabWidget(self.SettingsTab)
        self.tabWidget_7.setObjectName(u"tabWidget_7")
        self.tabWidget_7.setEnabled(True)
        self.tabWidget_7.setFont(font1)
        self.tabWidget_7.setAutoFillBackground(False)
        self.tabWidget_7.setInputMethodHints(Qt.InputMethodHint.ImhFormattedNumbersOnly)
        self.tabWidget_7.setTabPosition(QTabWidget.TabPosition.South)
        self.tabWidget_7.setIconSize(QSize(16, 16))
        self.tabWidget_7.setElideMode(Qt.TextElideMode.ElideNone)
        self.tabWidget_7.setUsesScrollButtons(False)
        self.tabWidget_7.setDocumentMode(False)
        ...
        self.tabWidget_7.addTab(self.pf_tab, icon5, "")
        ...
        self.tabWidget_7.addTab(self.cpf_tab, icon10, "")
        ...
        self.tabWidget_7.addTab(self.opf_tab, icon15, "")
        ...
        self.tabWidget_7.addTab(self.ntc_tab, icon45, "")
        ...
        self.tabWidget_7.addTab(self.nodal_capacity_tab, icon70, "")
        ...
        self.tabWidget_7.addTab(self.transfer_tab, icon87, "")
        ...
        self.tabWidget_7.addTab(self.contingencies_tab, icon44, "")
        ...
        self.frame_111.setGeometry(QRect(9, 0, 174, 48))
        ...
        self.label_414 = QLabel(self.frame_111)
        ...
        self.horizontalLayout_52.addWidget(self.label_414)
        ...
        self.label_405.setGeometry(QRect(10, 100, 101, 16))
        ...
        self.sim_time_spinBox.setGeometry(QRect(130, 70, 191, 23))
        ...
        self.tolerance_rms_spinBox.setGeometry(QRect(130, 40, 191, 23))
        ...
        self.rms_int_method_comboBox.setGeometry(QRect(130, 10, 200, 23))
        ...
        self.tabWidget_7.addTab(self.rms_tab, icon79, "")
        self.ml_tab = QWidget()
        ...
        self.tabWidget_7.addTab(self.ml_tab, icon57, "")
        ...
        self.label_81.setPalette(palette41)
        ...
        self.line_20.setPalette(palette42)
        ...
        self.label_85.setPalette(palette43)
        ...
        self.line_8.setPalette(palette44)
        ...
        self.tabWidget_7.addTab(self.topology_tab, icon13, "")
        ...
        self.label_131.setPalette(palette46)
        ...
        self.line_33.setPalette(palette47)
        ...
        self.label_115.setPalette(palette48)
        ...
        self.line_31.setPalette(palette49)
        ...
        palette50.setBrush(QPalette.Inactive, QPalette.WindowText, brush5)
        palette50.setBrush(QPalette.Disabled, QPalette.WindowText, brush1)
        self.label_134.setPalette(palette50)
        ...
        self.tabWidget_7.addTab(self.file_tab, icon4, "")
        self.tab_5 = QWidget()
        ...
        self.tabWidget_7.addTab(self.tab_5, icon71, "")

        self.gridLayout_8.addWidget(self.tabWidget_7, 0, 2, 1, 1)
...
"(mark to ask)", None))
...
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setToolTip(QCoreApplication.translate("mainWindow", u"<html><head/><body><p>Initial time for the simulation. </p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.pf_tab), QCoreApplication.translate("mainWindow", u"Pf", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.pf_tab), QCoreApplication.translate("mainWindow", u"Power flow settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.cpf_tab), QCoreApplication.translate("mainWindow", u"Cpf", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.cpf_tab), QCoreApplication.translate("mainWindow", u"Continuation power flow related settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.opf_tab), QCoreApplication.translate("mainWindow", u"Opf", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.opf_tab), QCoreApplication.translate("mainWindow", u"Optimal power flow settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.ntc_tab), QCoreApplication.translate("mainWindow", u"Ntc", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.ntc_tab), QCoreApplication.translate("mainWindow", u"Network transfer capacity related settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.nodal_capacity_tab), QCoreApplication.translate("mainWindow", u"Nhc", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.nodal_capacity_tab), QCoreApplication.translate("mainWindow", u"Nodal hosting capacity related settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.transfer_tab), QCoreApplication.translate("mainWindow", u"Txfr", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.transfer_tab), QCoreApplication.translate("mainWindow", u"Area, Zone, etc related settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.contingencies_tab), QCoreApplication.translate("mainWindow", u"Con", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.contingencies_tab), QCoreApplication.translate("mainWindow", u"Contingencies related settings", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.rms_tab), QCoreApplication.translate("mainWindow", u"Rms", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.rms_tab), QCoreApplication.translate("mainWindow", u"Rms simulation settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.ml_tab), QCoreApplication.translate("mainWindow", u"ML", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.ml_tab), QCoreApplication.translate("mainWindow", u"Machine learning related settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.topology_tab), QCoreApplication.translate("mainWindow", u"Tplgy", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.topology_tab), QCoreApplication.translate("mainWindow", u"Topology related settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.file_tab), QCoreApplication.translate("mainWindow", u"File", None))
#if QT_CONFIG(tooltip)
        self.tabWidget_7.setTabToolTip(self.tabWidget_7.indexOf(self.file_tab), QCoreApplication.translate("mainWindow", u"File related settings", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        ...
        self.tabWidget_7.setTabText(self.tabWidget_7.indexOf(self.tab_5), QCoreApplication.translate("mainWindow", u"Server", None))
